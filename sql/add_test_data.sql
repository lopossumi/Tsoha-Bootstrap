...
VALUES('spede1', 'Pertti Pasanen', '$1$IVbaNVZd$QW60i6BtJ7N5DJI1ZUZOD1', 'spede@spe.de');
...
INSERT INTO Task (id_tasklist, name, duedate, priority, status)  VALUES('1', 'Imuroi astiat',           '2016-10-17 16:00:00',  3, 0);
INSERT INTO Task (id_tasklist, name, duedate, priority, status)  VALUES('1', 'Tiskaa lattiat',          '2016-10-16 16:00:00',  2, 0);
INSERT INTO Task (id_tasklist, name, duedate, priority, status)  VALUES('1', 'Kastele stereot',         '2016-10-15 16:00:00',  1, 0);
